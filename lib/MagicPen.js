...
MagicPen.prototype.theme = function (format, theme) {
    if (theme) {
        this._themes[format] = extend({}, this._themes[format] || {}, theme);
        Object.keys(theme).forEach(function (themeEntry) {
            if (!this[themeEntry]) {
                this.addStyle(themeEntry, function (content) {
