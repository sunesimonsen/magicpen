...
MagicPen.prototype.replaceText = function (regexp, cb) {
    ...
    output.forEach(function (line, i) {
        ...
        line.forEach(function (outputEntry, j) {
            ...
            if (lastIndex === 0) {
                replacedOutput.output[replacedOutput.output.length - 1].push(outputEntry);
    ...
    this.output = replacedOutput.output;
