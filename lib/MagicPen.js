...
var squeezeLines = require('./squeezeLines')
...
function MagicPen(options) {
    ...
    this._themes = {};
    this.preferredWidth = options.preferredWidth || (!process.browser && process.stdout.columns) || 80;
    if (options.format) {
...
MagicPen.prototype.toString = function (format) {
    ...
    return serializer.serialize(squeezeLines(this.output, this.preferredWidth));
};
...
MagicPen.prototype.split = function () {
    return this.write({ style: 'split' });
};
